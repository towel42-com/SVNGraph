...
public:
    ...
    void setAllowXZoom( bool allow ){ fAllowXZoom = allow; }
    bool allowXZoom() const{ return fAllowXZoom; }
    void setAllowYZoom( bool allow ){ fAllowYZoom = allow; }
    bool allowYZoom() const{ return fAllowYZoom; }
private:
    bool fAllowXZoom;
    bool fAllowYZoom;
};
